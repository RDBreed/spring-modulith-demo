...
public class InMemoryNewsDatabase {
    ...
    public void saveNewsList(String country, List<NewsService.News> news) {
        newsByCountry.put(country, toNews(news));
    }

    public void saveNews(String country, NewsService.News news) {
        List<News> newsList = newsByCountry.getOrDefault(country, new ArrayList<>());
